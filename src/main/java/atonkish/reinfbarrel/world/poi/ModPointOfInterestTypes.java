...
public class ModPointOfInterestTypes {
  public static void init() {
    ...
    PointOfInterestType fishermanPoiType =
        Registries.POINT_OF_INTEREST_TYPE.get(PointOfInterestTypes.FISHERMAN);

    RegistryEntry<PointOfInterestType> fishermanEntry =
        Registries.POINT_OF_INTEREST_TYPE.getEntry(fishermanPoiType);
